      ...
      <div className="max-w-6xl mx-auto mobile-adaptive-container mobile-section-spacing">
        ...
        {currentView === 'records' && (
          <div className="text-center">
            <h1 className="mobile-text-responsive-base sm:text-2xl lg:text-4xl font-bold mb-2 text-white drop-shadow-lg mobile-text-readable">
          ...
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            >
              ...
              <TruncatedText
                ...
                useFallbackAt={6}
                fallbackIcon={null}
                className="font-medium mobile-text-responsive hidden xs:inline"
                showTooltip={false}
              />
            </Link>
            
            <h1 className="mobile-text-responsive-sm sm:text-xl lg:text-2xl font-bold text-white drop-shadow-lg mobile-text-readable text-center flex-1 min-w-0">
              <TruncatedText
                text="ACTIVITÉS"
                maxLength={12}
                className="block"
            ...
            {/* Espace équilibré */}
            <div className="mobile-touch-target-sm flex-shrink-0"></div>
          </div>
        )}
